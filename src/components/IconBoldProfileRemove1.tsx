...
export interface IconBoldProfileRemove1Props extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const IconBoldProfileRemove1: React.FC<IconBoldProfileRemove1Props> = ({
  size = '1em',
  ...props
}) => {
  return (
