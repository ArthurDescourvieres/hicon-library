...
export interface IconLinearShieldTickProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const IconLinearShieldTick: React.FC<IconLinearShieldTickProps> = ({
  size = '1em',
  ...props
}) => {
  return (
