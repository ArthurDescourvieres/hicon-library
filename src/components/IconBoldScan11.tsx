...
export interface IconBoldScan11Props extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const IconBoldScan11: React.FC<IconBoldScan11Props> = ({
  size = '1em',
  ...props
}) => {
  return (
