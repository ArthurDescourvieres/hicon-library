...
export interface IconLinearUndoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const IconLinearUndo: React.FC<IconLinearUndoProps> = ({
  size = '1em',
  ...props
}) => {
  return (
