...
export interface IconLinearPauseOctagonProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const IconLinearPauseOctagon: React.FC<IconLinearPauseOctagonProps> = ({
  size = '1em',
  ...props
}) => {
  return (
