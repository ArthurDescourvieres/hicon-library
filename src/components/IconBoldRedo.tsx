...
export interface IconBoldRedoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const IconBoldRedo: React.FC<IconBoldRedoProps> = ({
  size = '1em',
  ...props
}) => {
  return (
