...
export interface IconBoldLogoutProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const IconBoldLogout: React.FC<IconBoldLogoutProps> = ({
  size = '1em',
  ...props
}) => {
  return (
