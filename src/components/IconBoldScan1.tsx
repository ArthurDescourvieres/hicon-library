...
export interface IconBoldScan1Props extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const IconBoldScan1: React.FC<IconBoldScan1Props> = ({
  size = '1em',
  ...props
}) => {
  return (
