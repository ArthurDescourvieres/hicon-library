...
export interface IconBoldStopProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const IconBoldStop: React.FC<IconBoldStopProps> = ({
  size = '1em',
  ...props
}) => {
  return (
