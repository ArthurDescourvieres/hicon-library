...
export interface IconBoldCloseSquareProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const IconBoldCloseSquare: React.FC<IconBoldCloseSquareProps> = ({
  size = '1em',
  ...props
}) => {
  return (
