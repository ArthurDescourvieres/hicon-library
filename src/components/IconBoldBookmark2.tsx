...
export interface IconBoldBookmark2Props extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const IconBoldBookmark2: React.FC<IconBoldBookmark2Props> = ({
  size = '1em',
  ...props
}) => {
  return (
