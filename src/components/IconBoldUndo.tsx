...
export interface IconBoldUndoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const IconBoldUndo: React.FC<IconBoldUndoProps> = ({
  size = '1em',
  ...props
}) => {
  return (
