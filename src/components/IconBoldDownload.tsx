...
export interface IconBoldDownloadProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const IconBoldDownload: React.FC<IconBoldDownloadProps> = ({
  size = '1em',
  ...props
}) => {
  return (
