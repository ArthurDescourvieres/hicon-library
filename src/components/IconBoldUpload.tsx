...
export interface IconBoldUploadProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const IconBoldUpload: React.FC<IconBoldUploadProps> = ({
  size = '1em',
  ...props
}) => {
  return (
