...
export interface IconBoldActivity2Props extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const IconBoldActivity2: React.FC<IconBoldActivity2Props> = ({
  size = '1em',
  ...props
}) => {
  return (
