...
export interface IconLinearTickSquareProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const IconLinearTickSquare: React.FC<IconLinearTickSquareProps> = ({
  size = '1em',
  ...props
}) => {
  return (
