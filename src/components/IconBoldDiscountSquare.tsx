...
export interface IconBoldDiscountSquareProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const IconBoldDiscountSquare: React.FC<IconBoldDiscountSquareProps> = ({
  size = '1em',
  ...props
}) => {
  return (
