...
export interface IconLinearStar2Props extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const IconLinearStar2: React.FC<IconLinearStar2Props> = ({
  size = '1em',
  ...props
}) => {
  return (
