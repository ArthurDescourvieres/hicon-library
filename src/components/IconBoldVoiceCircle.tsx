...
export const IconBoldVoiceCircle: React.FC<IconBoldVoiceCircleProps> = ({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path fill="currentColor" fill-rule="evenodd" d="M1.25 12C1.25 6.063 6.063 1.25 12 1.25S22.75 6.063 22.75 12 17.937 22.75 12 22.75 1.25 17.937 1.25 12m11.5-4a.75.75 0 0 0-1.5 0v8a.75.75 0 0 0 1.5 0zm-3 1a.75.75 0 0 0-1.5 0v6a.75.75 0 0 0 1.5 0zm6 0a.75.75 0 0 0-1.5 0v6a.75.75 0 0 0 1.5 0zm-9 2a.75.75 0 0 0-1.5 0v2a.75.75 0 0 0 1.5 0zm12 0a.75.75 0 0 0-1.5 0v2a.75.75 0 0 0 1.5 0z" clip-rule="evenodd"/>
    </svg>
  );
};
