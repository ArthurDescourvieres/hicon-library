...
export interface IconBoldTickProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const IconBoldTick: React.FC<IconBoldTickProps> = ({
  size = '1em',
  ...props
}) => {
  return (
